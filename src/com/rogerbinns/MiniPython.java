 ...
 * See https://github.com/rogerbinns/jia-mini-python for the project page,
		...
		public boolean equals(Object other) {
			return other instanceof TBuiltinInstanceMethod
					&& this.toString().equals(
							((TBuiltinInstanceMethod) other).toString());
		}
	...
	private final Object mainLoop() throws ExecutionError {
		...
		opcodeswitch: while (true) {
			...
			case 160: // LOAD_NAME
			{
				...
				if (c.globals != null && c.globals.contains(key)) {
					c = root;
				}
				while (c != null) {

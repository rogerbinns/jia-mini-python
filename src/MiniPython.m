        ...
        switch (op) {
            ...
            case 15: // SUBSCRIPT_SLICE
            {
                ...
                if (ISLIST(object)) {
                    ...
                    NSArray *sub = [L(object) subarrayWithRange:NSMakeRange((NSUInteger) ifrom,
                        (NSUInteger) (ito - ifrom))];
                    NSMutableArray *res = [NSMutableArray arrayWithCapacity:[sub count]];
                    [res addObjectsFromArray:sub];
                    stack[++stacktop] = res;
                } else {
                    stack[++stacktop] = [S(object) substringWithRange:NSMakeRange((NSUInteger) ifrom,
                        (NSUInteger) (ito - ifrom))];
                }
                continue;
            }

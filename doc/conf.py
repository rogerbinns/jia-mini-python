# -*- coding: utf-8 -*-
#
# Java Mini Python documentation build configuration file, created by
...
texinfo_documents = [
  ('index', 'JavaMiniPython', u'Java Mini Python Documentation',
   u'Roger Binns', 'JavaMiniPython', 'One line description of project.',
   'Miscellaneous'),
]
